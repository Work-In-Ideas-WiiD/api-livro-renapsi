              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
                    <tr v-for="pedido in pedidos.data" v-bind:key="pedido.id">
                        ...
                        <td>{{ pedido.data_pagamento != null ? pedido.data_pagamento : '' }}</td>
                        ...
                        <td>
                            ...
                            <router-link v-if="$auth.check(3)" :to="'/pedido_imprimir/' + pedido.id + '/true'" target="_blank" class="btn btn-sm btn-primary"> <i class="fas fa-fw fa-print"></i></router-link >
                        </td>
                    </tr>
                </tbody>
              </table>
