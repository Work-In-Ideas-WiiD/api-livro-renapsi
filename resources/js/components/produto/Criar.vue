<template>
    ...
    <!-- Outer Row -->
        ...
        <div class="card-body">
            <form-wizard title="Cadastrar Produto" subtitle="Cadastro novo produto"
            color="#000"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group input-group-merge input-group-alternative">
                                ...
                                <input class="form-control" v-model="nome" placeholder="Nome do Produto" type="text">
                            </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group input-group-merge input-group-alternative">
                                ...
                                <input class="form-control" v-model="sku" placeholder="Codígo Referência" type="text">
                            </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group input-group-merge input-group-alternative">
                                ...
                                <b-form-select class="dorder-select" v-model="marca" :options="marcas" ></b-form-select>
                            </div>
                        ...
                        <div class="form-group col-md-3">
                            <div class="input-group input-group-merge input-group-alternative">
                                <div class="input-group-prepend">
                                 ...
                                 <b-form-select :disabled="$auth.check(6)" v-model="status" :options="opcoes"></b-form-select>
                            </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group input-group-merge input-group-alternative">
                                ...
                                <input class="form-control" v-mask="['##.##', '###.##', '####.##']" v-model="preco" placeholder="Preço" type="text">
                            </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group input-group-merge input-group-alternative">
                                ...
                                <input class="form-control" v-mask="['##.##', '###.##', '####.##']" v-model="preco_atacado" placeholder="Preço Atacado" type="text">
                            </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group input-group-merge input-group-alternative">
                                ...
                                <input class="form-control" v-mask="['##.##', '###.##', '####.##']" v-model="custo" placeholder="Preço Custo" type="text">
                            </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group input-group-merge input-group-alternative">
                                ...
                                <input class="form-control" v-model="referencia" placeholder="Codigo SKU" type="text">
                            </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group input-group-merge input-group-alternative">
                                ...
                                <input class="form-control" v-mask="'######'" v-model="quantidade_minima" placeholder="Quantidade Minima Atacado" type="text">
                            </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group input-group-merge input-group-alternative">
                                ...
                                <input class="form-control" v-mask="['#.###']" v-model="peso" placeholder="Peso kg" type="text">
                            </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group input-group-merge input-group-alternative">
                                ...
                                <input class="form-control" v-mask="'#####'" v-model="comprimento" placeholder="Comprimento cm" type="text">
                            </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group input-group-merge input-group-alternative">
                                ...
                                <input class="form-control" v-mask="'#####'" v-model="altura" placeholder="Altura cm" type="text">
                            </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group input-group-merge input-group-alternative">
                                ...
                                <input class="form-control" v-mask="'#####'" v-model="largura" placeholder="Largura cm" type="text">
                            </div>
                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody class="list">
                            <tr v-for="atributo_produto in atributo_produtos.data" v-bind:key="atributo_produto.id" style="margin-bottom: 5px;">
                                ...
                                <td>
                                    <button class="btn-circle btn-sm btn-danger" title="Deletar" data-toggle="modal" data-target="#modal-delete" block ><i class="fas fa-fw fa-trash-alt"></i></button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
export default {
    ...
    methods: {
      ...
      postProduto() {
        ...
        formData.append('sku',  app.sku)
        formData.append('slug',  this.string_to_slug(app.nome))
        formData.append('marca_id',  app.marca)
        formData.append('preco',  app.preco)
        formData.append('preco_atacado',  app.preco_atacado)
        formData.append('custo',  app.custo)
        formData.append('referencia',  app.referencia)
        formData.append('quantidade_minima',  app.quantidade_minima)
        ...
        formData.append('peso',  app.peso)
        formData.append('comprimento',  app.comprimento)
        formData.append('altura',  app.altura)
        formData.append('largura',  app.largura)
        ...
        formData.append('preco',  app.preco)
        formData.append('preco_atacado',  app.preco_atacado)
        formData.append('quantidade',  app.quantidade)
        formData.append('quantidade_minima',  app.quantidade_minima)
        formData.append('descricao',  app.descricao)
        formData.append('capa',  app.capa)
        formData.append('status',  app.status)
        ...
        uploadImageSuccess(formData, index, fileList) {
            var app = this
            formData.append('produto_id',  app.produto_id)
        ...
        beforeRemove (index, done, fileList) {
            this.$http({
            url: `image/` + this.produto_id + '/' + index,
            method: 'DELETE',
            })
            .then(response=>{
                done()
